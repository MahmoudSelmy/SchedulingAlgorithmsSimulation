...
import com.example.techlap.operatingsystems.Adapter.SJFAdapterRecycler;
...
public class SjfActivity extends AppCompatActivity {
    ...
    private SJFAdapterRecycler mAdapter;
    ...
    private ArrayList<ProcessSJF> buffer;
    private int time = 0 ;
    @Override
    ...
    private void initViews() {
        ...
        mAdapter = new SJFAdapterRecycler(this , false);
        ...
        inPause =  true;
        inStart = true;
        buffer = new ArrayList<ProcessSJF>();
        ...
        radioGroup.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                ...
                Toast.makeText(SjfActivity.this,""+preemptivity, Toast.LENGTH_SHORT).show();
            }
        });
            ...
            public void handleMessage(Message msg) {
                ...
                if(msg.arg2 == 1) {
                    ...
                    if(buffer.size() >0){
                        ...
                        ProcessSJF process = buffer.get(buffer.size() - 1);
                        mAdapter.addProcess(process.remainingMilis, preemptivity,time);
                        buffer.clear();
    ...
    private void prepareThread(){
        if(!mAdapter.isEmpty()&&buffer.isEmpty()) {
            final ProcessSJF process = mAdapter.popToCPU(time);
        ...
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        for (ProcessSJF process : mAdapter.switched){
                        ...
                        Intent intent = new Intent(SjfActivity.this,ChartActivity.class);
